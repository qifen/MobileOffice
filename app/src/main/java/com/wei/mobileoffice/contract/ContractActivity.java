 ...
 */
public class ContractActivity extends FragmentActivity implements ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    private void initView() {
        ((TextView) findViewById(R.id.title_bar_title)).setText("合同");
        // 初始化横着滚动的title
