 ...
 */
public class BusinessActivity extends FragmentActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    private void initView() {
        ((TextView) findViewById(R.id.title_bar_title)).setText("跟进");
        // 初始化横着滚动的title
    ...
    private class VideoPagerAdapter extends FragmentStatePagerAdapter {
        ...
        private String[] business_names;

        public VideoPagerAdapter(FragmentManager fm) {
            super(fm);
            business_names = UIHelper.getStringArray(R.array.business_names);
        }

        @Override
        public CharSequence getPageTitle(int position) {
            return business_names[position];
        }
