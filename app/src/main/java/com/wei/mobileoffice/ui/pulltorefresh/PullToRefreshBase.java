...
//					: View.LAYER_TYPE_NONE);
	...
	private void callRefreshListener() {
		if (null != mOnRefreshListener) {
			...
			//String title = getResources().getString(R.string.pull_to_refresh_recent_update);
			//this.getLoadingLayoutProxy().setLastUpdatedLabel(title + new Date().toLocaleString());
