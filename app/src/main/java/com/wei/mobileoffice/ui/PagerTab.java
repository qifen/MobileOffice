package com.wei.mobileoffice.ui;
...
public class PagerTab extends ViewGroup {
	...
	private int mIndicatorColor = 0xFF3F51B5;//指示器颜色
	...
	private void addTextTab(final int position, String title) {
		...
		tab.setTextColor(UIHelper.getColorStateList(mTabTextColorResId));
		tab.setBackgroundDrawable(UIHelper.getDrawable(mTabBackgroundResId));
