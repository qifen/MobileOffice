...
public class StringUtil {
    ...
    /*
     * 判断String是否为null或者字符形式的"null"、"NULL"，避免在页面显示null
     */
    ...
    public static String optJsonString(JSONObject json, String name){
        String callback="";
        return json!=null?json.optString(name):callback;
    }

    public static boolean hasBlankStr(String[] ss){
        for(int i=0; i< ss.length; i++){
            if(isBlank(ss[i]))return true;
        }
        return false;
    }

    public static String replaceNullString(String str){
        return NULL_STRING.equals(str)?"":str;
    }
}
